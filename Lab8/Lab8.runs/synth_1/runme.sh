...
HD_PWD='D:/GithubLocalRepo/CODLAB/Lab8/Lab8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RV32ICore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RV32ICore.tcl
