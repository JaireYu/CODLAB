...
HD_PWD='D:/verilog2/lab2_1/lab2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_1.tcl -notrace
