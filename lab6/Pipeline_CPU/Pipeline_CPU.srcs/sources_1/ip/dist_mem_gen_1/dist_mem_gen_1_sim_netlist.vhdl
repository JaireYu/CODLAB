...
-- Date        : Fri May 31 18:36:54 2019
-- Host        : DESKTOP-MBF5BR3 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               D:/verilog2/Pipeline_CPU/Pipeline_CPU.srcs/sources_1/ip/dist_mem_gen_1/dist_mem_gen_1_sim_netlist.vhdl
...
ram_reg_0_127_0_0: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"00000000000000000000000061ED307C"
    )
        port map (
...
ram_reg_0_127_1_1: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"0000000000000000000000003199AFD0"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(1),
...
ram_reg_0_127_2_2: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000B34B1AAA"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(2),
...
ram_reg_0_127_3_3: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000B071E81F"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(3),
...
ram_reg_0_127_4_4: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"000000000000000000000000E49A0B3D"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(4),
...
ram_reg_0_127_5_5: unisim.vcomponents.RAM128X1D
    generic map(
      INIT => X"00000000000000000000000008000000"
    )
        port map (
      A(6 downto 0) => a(6 downto 0),
      D => d(5),
...
entity dist_mem_gen_1_dist_mem_gen_v8_0_12 is
  ...
  attribute C_ADDR_WIDTH of dist_mem_gen_1_dist_mem_gen_v8_0_12 : entity is 8;
  attribute C_DEFAULT_DATA : string;
  attribute C_DEFAULT_DATA of dist_mem_gen_1_dist_mem_gen_v8_0_12 : entity is "0";
  attribute C_DEPTH : integer;
  attribute C_DEPTH of dist_mem_gen_1_dist_mem_gen_v8_0_12 : entity is 256;
  ...
  attribute C_HAS_DPO of dist_mem_gen_1_dist_mem_gen_v8_0_12 : entity is 1;
  attribute C_HAS_DPRA : integer;
  attribute C_HAS_DPRA of dist_mem_gen_1_dist_mem_gen_v8_0_12 : entity is 1;
  ...
  attribute C_MEM_TYPE of dist_mem_gen_1_dist_mem_gen_v8_0_12 : entity is 2;
