...
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { PCrst }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { Regrst }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]
#set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { Mem_or_RF }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]
...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { Debug_Addr[0] }]; #IO_L24N_T3_34 Sch=sw[8]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { Debug_Addr[1] }]; #IO_25_34 Sch=Debug_Addr[9]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { Debug_Addr[2] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=Debug_Addr[10]
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { Debug_Addr[3] }]; #IO_L23P_T3_A03_D19_14 Sch=Debug_Addr[11]
set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { Debug_Addr[4] }]; #IO_L24P_T3_35 Sch=Debug_Addr[12]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { Debug_Addr[5] }]; #IO_L20P_T3_A08_D24_14 Sch=Debug_Addr[13]
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { Debug_Addr[6] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=Debug_Addr[14]
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { Debug_Addr[7] }]; #IO_L21P_T3_DQS_14 Sch=Debug_Addr[15]
