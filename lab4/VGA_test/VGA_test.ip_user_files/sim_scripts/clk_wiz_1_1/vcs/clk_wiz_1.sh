...
#
# Generated by Vivado on Mon Apr 22 22:21:20 +0800 2019
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../VGA_test.srcs/sources_1/ip/clk_wiz_1_1" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../VGA_test.srcs/sources_1/ip/clk_wiz_1_1" \
    "$ref_dir/../../../../VGA_test.srcs/sources_1/ip/clk_wiz_1_1/clk_wiz_1_sim_netlist.v" \
  2>&1 | tee -a vlogan.log
