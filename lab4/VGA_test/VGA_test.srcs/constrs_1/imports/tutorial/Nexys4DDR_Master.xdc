...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { data[8] }]; #IO_L24N_T3_34 Sch=data[8]
set_property -dict { PACKAGE_PIN U8    IOSTANDARD LVCMOS18 } [get_ports { data[9] }]; #IO_25_34 Sch=data[9]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { data[10] }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=data[10]
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { data[11] }]; #IO_L23P_T3_A03_D19_14 Sch=y0[11]
#set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { y0[4] }]; #IO_L24P_T3_35 Sch=y0[12]
#set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { y0[5] }]; #IO_L20P_T3_A08_D24_14 Sch=y0[13]
#set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { y0[6] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=y0[14]
...
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { dir[2] }]; #IO_L4N_T0_D05_14 Sch=btnu
...
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { dir[0] }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
...
set_property -dict { PACKAGE_PIN C6    IOSTANDARD LVCMOS33 } [get_ports { vrgb[4] }]; #IO_L1P_T0_AD4P_35 Sch=vrgb[0]
set_property -dict { PACKAGE_PIN A5    IOSTANDARD LVCMOS33 } [get_ports { vrgb[5] }]; #IO_L3N_T0_DQS_AD5N_35 Sch=vrgb[1]
set_property -dict { PACKAGE_PIN B6    IOSTANDARD LVCMOS33 } [get_ports { vrgb[6] }]; #IO_L2N_T0_AD12N_35 Sch=vrgb[2]
set_property -dict { PACKAGE_PIN A6    IOSTANDARD LVCMOS33 } [get_ports { vrgb[7] }]; #IO_L3P_T0_DQS_AD5P_35 Sch=vrgb[3]

set_property -dict { PACKAGE_PIN B7    IOSTANDARD LVCMOS33 } [get_ports { vrgb[8] }]; #IO_L2P_T0_AD12P_35 Sch=vrgb[0]
set_property -dict { PACKAGE_PIN C7    IOSTANDARD LVCMOS33 } [get_ports { vrgb[9] }]; #IO_L4N_T0_35 Sch=vrgb[1]
set_property -dict { PACKAGE_PIN D7    IOSTANDARD LVCMOS33 } [get_ports { vrgb[10] }]; #IO_L6N_T0_VREF_35 Sch=vrgb[2]
